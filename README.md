...
[19] | FTP User footprint | :heavy_check_mark:
[20] | MYSQL User footprint | :heavy_check_mark:
[21] | Simple Google Bot for web scan | :x:
[22] | Auto website comment bot | :x:
[23] | Auto website message bot | :x:
[24] | Web-scrapping using Regex | :heavy_check_mark:
[25] | Bot to collect information about someone using Google / Bing / Yahoo! | :heavy_check_mark:
[26] | Simple SQLi tester | :heavy_check_mark:
[27] | Simple XSS tester | :heavy_check_mark:
[28] | Simple Wordpress brute-forcer | :x:
[29] | SQLi database retriever | :x:
[30] | Spam creator | :heavy_check_mark:

-------------------------------------------------------------------------------------------------------------------------------------------
Level 3 | Advanced Network Attacks | Example
------------------------------------------------|-------------------------------------------|----------------------------------------------
[31] | Payload for reverse shell | :heavy_check_mark:
[32] | Payload to capture screenshots | :heavy_check_mark:
[33] | Implement a Botnet | :x:
[34] | Passive web scanner | :x:
[35] | ARP poisoning tool | :heavy_check_mark:
...
[43] | IRC Server | :x:
[44] | Packet Capture tool | :heavy_check_mark:
...
[48] | Payload that moves the mouse cursor | :heavy_check_mark:
[49] | Vigenère Cipher | :heavy_check_mark:
...
[57] | Gateway | :x:
[58] | Powershell payload generator | :heavy_check_mark:
[59] | Bash payload generator | :heavy_check_mark:
[60] | Subdomain enumerator | :heavy_check_mark:
[61] | DNS Enumerator | :heavy_check_mark:
...
[69] | Process monitor (Windows and Linux) | :heavy_check_mark:
...
[80] | Script for OS enumeration (after shell) | :heavy_check_mark:
[81] | RSA Payload generator | :x:
[82] | Handshake capture | :x:
[83] | Wifi monitor | :heavy_check_mark:
[84] | Buffer Overflow exploit | :x:
[85] | Stack Overflow exploit | :x:
[86] | Banner exploit | :x:
[87] | ISS Exploit | :x:
[88] | Wifi de-authentication attack (DoS) tool | :x:
[89] | Badchar detector | :heavy_check_mark:
[90] | Firewall detector | :heavy_check_mark:
